...
namespace Speader.Controls
{
    ...
    public sealed class SpeaderNumericUpDown : RangeBase
    {
        ...
        private TextBlock _valueTextBox;
        ...
        {
            var target = (SpeaderNumericUpDown)d;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SpeaderNumericUpDown" /> class.
        /// </summary>
        public SpeaderNumericUpDown()
        {
            this.DefaultStyleKey = typeof(SpeaderNumericUpDown);
        }
